				...
				<div class="row">
					...
					<div class="col-md-5 wrapthumbnail">
						<a href="{{ url($article->slug) }}">
							<div class="thumbnail" style="background-image:url({{ $article->page_image }});">
							</div>
						</a>
					</div>
					@endif
						...
						<div class="card-block">
							...
							<div class="metafooter">
								<div class="wrapfooter">
									...
									<span class="post-date">{{ $article->published_at->diffForHumans() }}</span><span class="dot"></span><span class="post-read">6 min read</span>
									</span>
